...
urlpatterns = [
    ...
    path('api/article/<slug:slug>/', views.api_article, name='api_article'),
    ...
    path('<slug:slug>/toggle-personal/', views.article_toggle_personal, name='article_toggle_personal'),
